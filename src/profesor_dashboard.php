                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="editar_prueba.php?id=<?= $prueba['id'] ?>" class="btn btn-primary btn-sm">✏️ Editar</a>
                                <a href="estado_prueba.php?id=<?= $prueba['id'] ?>" class="btn btn-warning btn-sm">🔄 Estado</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
