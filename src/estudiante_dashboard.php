                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card shadow-sm h-100 <?= $ya_rendida ? 'border-success' : 'border-primary' ?>">
                            <div class="card-body">
                                ...
                                <?php if ($ya_rendida): ?>
                                    <div class="alert alert-success p-2 text-center mb-2">
                                        <strong>Calificación: <?= $puntaje ?></strong><br>
                                        <small>Ya completaste esta prueba</small>
                                    </div>
                                    <!-- Botón agregado para ver el detalle de los errores -->
                                    <a href="ver_revision.php?prueba_id=<?= $prueba['id'] ?>"
                                        class="btn btn-outline-success btn-sm w-100">🔍 Ver revisión y errores</a>
                                <?php else: ?>
                                    <a href="rendir_prueba.php?prueba_id=<?= $prueba['id'] ?>" class="btn btn-primary w-100">📝
                                        Iniciar Prueba</a>
                                <?php endif; ?>
                            </div>
                        </div>
