    ...
    <div class="row text-center mb-5">
        ...
        <div class="col-md-3 mb-3">
            <div class="card shadow-sm border-0 bg-warning text-dark">
                <div class="card-body">
                    <h6>Nota Promedio</h6>
                    <h2 class="fw-bold"><?= $stats['nota_promedio'] !== null ? round($stats['nota_promedio'], 2) : 'N/A' ?> / 10</h2>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-3">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="5" class="text-center text-muted py-4">Ningún estudiante ha rendido esta prueba todavía.</td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
