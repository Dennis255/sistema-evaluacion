...
try {
    ...
    // 3. Obtener el listado de los alumnos que rindieron la prueba y sus notas
    $stmtAlumnos = $pdo->prepare("
        SELECT u.nombre, u.email, r.calificacion, r.fecha_rendicion
        FROM resultados r
    ...
    <div class="container">
        ...
        <div class="row text-center mb-5">
            ...
            <div class="col-md-3 mb-3">
                <div class="card shadow-sm border-0 bg-success text-white">
                    <div class="card-body">
                        <h6>Nota Máxima</h6>
                        <h2 class="fw-bold"><?= $stats['nota_maxima'] !== null ? $stats['nota_maxima'] : 'N/A' ?> / 10
                        </h2>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 mb-3">
                <div class="card shadow-sm border-0 bg-danger text-white">
                    <div class="card-body">
                        <h6>Nota Mínima</h6>
                        <h2 class="fw-bold"><?= $stats['nota_minima'] !== null ? $stats['nota_minima'] : 'N/A' ?> / 10
                        </h2>
                    </div>
                </div>
            </div>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body p-4">
                ...
                <p class="text-muted small mb-4">Lista de alumnos que han completado esta evaluación y su respectivo
                    rendimiento.</p>
                            ...
                            <?php foreach ($alumnos_resultados as $index => $res): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="ver_intento_estudiante.php?estudiante_id=<?= $res['estudiante_id'] ?>&prueba_id=<?= $prueba_id ?>"
                                            class="btn btn-sm btn-primary">🔍 Ver Examen</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <tbody>
                            ...
                            <?php if (count($alumnos_resultados) === 0): ?>
                                <tr>
                                    <td colspan="5" class="text-center text-muted py-4">Ningún estudiante ha rendido esta
                                        prueba todavía.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
